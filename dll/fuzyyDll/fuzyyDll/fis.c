...
DOUBLE fisArrayOperation(DOUBLE* array, int size, DOUBLE(*fcn)(DOUBLE, DOUBLE))
{
	int i;
	DOUBLE out;
...
DOUBLE defuzzCentroid(FIS* fis, int m, DOUBLE* mf, int numofpoints)
{
...
DOUBLE defuzzBisector(FIS* fis, int m, DOUBLE* mf, int numofpoints)
{
	DOUBLE min = fis->output[m]->bound[0];
	DOUBLE max = fis->output[m]->bound[1];
	DOUBLE step = (max - min) / (numofpoints - 1);
...
DOUBLE defuzzMeanOfMax(FIS* fis, int m, DOUBLE* mf, int numofpoints)
{
	DOUBLE min = fis->output[m]->bound[0];
	DOUBLE max = fis->output[m]->bound[1];
	DOUBLE step = (max - min) / (numofpoints - 1);
...
DOUBLE defuzzSmallestOfMax(FIS* fis, int m, DOUBLE* mf, int numofpoints)
{
	DOUBLE min = fis->output[m]->bound[0];
	DOUBLE max = fis->output[m]->bound[1];
	DOUBLE step = (max - min) / (numofpoints - 1);
...
DOUBLE defuzzLargestOfMax(FIS* fis, int m, DOUBLE* mf, int numofpoints)
{
	DOUBLE min = fis->output[m]->bound[0];
	DOUBLE max = fis->output[m]->bound[1];
	DOUBLE step = (max - min) / (numofpoints - 1);
